...
def parse_args(input_args=None):
    ...
    parser.add_argument('--max_epochs', type=int, default=100) # 2000
...
print('Data Setting')
args.data_dir = "hipporag/rankformer"
...
if args.save_emb or args.load_emb:
    args.user_emb_path = 'saved/{args.dataset:s}_user.pt'
    args.item_emb_path = 'saved/{args.dataset:s}_item.pt'
    if args.save_emb:
